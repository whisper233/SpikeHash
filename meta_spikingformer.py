...
class Spiking_vit_MetaFormer(nn.Module):
    def __init__(
        ...
        self.apply(self.init_weights_kaiming_normal_)

    def initialize_weights_zero(self, model):
    ...
    def init_weights_kaiming_normal_(self, m):
    ...
    def forward(self, x):
        ...
        # hash_out = self.hash_head(x_lif).mean(0)
        out = self.head(out)
